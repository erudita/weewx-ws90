...
# EXtended still further by erudita:
#   more soil sensors, more battery levels,
#   irrigation volumes
#   electricity
# =============================================================================
...
table = [('dateTime',             'INTEGER NOT NULL UNIQUE PRIMARY KEY'),
         ...
         ('dewpoint1',            'REAL'),
         ('ET',                   'REAL'),
         ('electricityConsumed',  'REAL'),
         ('electricityImported',  'REAL'),
         ('electricityExported',  'REAL'),
         ('electricityProduced',  'REAL'),
         ('extraHumid1',          'REAL'),
         ('extraHumid2',          'REAL'),
         ('extraHumid3',          'REAL'),
         ('extraHumid4',          'REAL'),
         ...
         ('irrigationVolume1',    'REAL'),
         ('irrigationVolume2',    'REAL'),
         ('leafTemp1',            'REAL'),
         ('leafTemp2',            'REAL'),
         ('leafWet1',             'REAL'),
         ('leafWet2',             'REAL'),
         ...
         ('rainBatteryVoltage',   'REAL'),
         ('rainRate',             'REAL'),
         ('rainPiezo',            'REAL'),
         ('rainPiezoBatteryVoltage','REAL'),
         ('rainRatePiezo',        'REAL'),
         ...
         ('snowRate',             'REAL'),
         ('so2',                  'REAL'),
         ('soilBatteryVoltage1',  'REAL'),
         ('soilBatteryVoltage2',  'REAL'),
         ('soilBatteryVoltage3',  'REAL'),
         ('soilBatteryVoltage4',  'REAL'),
         ('soilBatteryVoltage5',  'REAL'),
         ('soilBatteryVoltage6',  'REAL'),
         ('soilBatteryVoltage7',  'REAL'),
         ('soilBatteryVoltage8',  'REAL'),
         ('soilBatteryVoltage9',  'REAL'),
         ('soilBatteryVoltage10', 'REAL'),
         ('soilMoist1',           'REAL'),
         ('soilMoist2',           'REAL'),
         ('soilMoist3',           'REAL'),
         ('soilMoist4',           'REAL'),
